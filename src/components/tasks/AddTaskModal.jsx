        ...
        <Modal isOpen={isOpen} setIsOpen={setIsOpen} title={"Programming Hero"}>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex flex-col mb-5">
                    ...
                    <select className="w-full rounded-md" type="date" id="assignTo" {...register('assignTo')}>
                        ...
                        <option value="Fahim Ahmaed Firoz">Fahim Ahmaed Firoz</option>
                ...
                <div className="flex flex-col mb-5">
                    ...
                    <select className="w-full rounded-md" type="date" id="priority" {...register('priority')} >
